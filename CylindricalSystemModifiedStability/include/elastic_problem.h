...
private:
	...
	void assemble_stability_system();
	void stability_solve();
	void solve();
	...
	SparseMatrix<double> stability_matrix;
	...
	Vector<double> stability_solution;
	Vector<double> linearsolve;
	Vector<double> system_rhs;
	Vector<double> stability_rhs;
